...
ActiveRecord::Schema.define(version: 20141207095212) do
  ...
  create_table "items_symptoms", id: false, force: true do |t|
    t.integer "item_id",    null: false
    t.integer "symptom_id", null: false
  end

  add_index "items_symptoms", ["item_id"], name: "index_items_symptoms_on_item_id", using: :btree
  add_index "items_symptoms", ["symptom_id"], name: "index_items_symptoms_on_symptom_id", using: :btree
